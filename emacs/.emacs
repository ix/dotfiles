...
(load-file "~/.emacs.d/omake/ligatures.el")
...
(custom-set-variables
 ...
 '(frame-title-format '(:eval (concat (current-dirname) "%b")) t)
 '(git-gutter:added-sign "❚")
 '(git-gutter:deleted-sign "❚")
 '(git-gutter:handled-bckends '(git hg) t)
 '(git-gutter:modified-sign "❚")
 '(global-display-line-numbers-mode t)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "PragmataPro Liga" :foundry "FSD " :slant normal :weight normal :height 88 :width normal))))
